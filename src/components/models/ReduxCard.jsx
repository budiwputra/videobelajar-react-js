                    ...
                    {course.map((item, index) => {
                        ...
                        return (
                            ...
                            <div className='flex flex-col gap-[9px] sm:gap-[16px] justify-center'>
                                ...
                                <BodyMedium className="hidden sm:block sm:text-base text-dark-secondary">{item.description.length > 60 ? item.description.slice(0, 60) : item.description}</BodyMedium>
                                </div>
                                ...
                                <div className='flex flex-row justify-between'>
                                    <button className='cursor-pointer hover:underline hover:text-secondary' onClick={() => navigate(`/dashboard/redux-update/${item.course_id}`) }>Edit</button>
                                    <button className='cursor-pointer hover:underline hover:text-error-default' onClick={() => dispatch(deleteData(item.course_id))}>Delete</button>
                                </div>
                            </div>
                            </div>
                        )
