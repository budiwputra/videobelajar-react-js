            ...
            return (
                ...
                <div className='flex flex-col gap-[9px] sm:gap-[16px] justify-center'>
                    ...
                    <div className='flex flex-row justify-between'>
                        <button className='cursor-pointer hover:underline' onClick={() => navigate(`/dashboard/product-edit/${e.id}`) }>Edit</button>
                        <button className='cursor-pointer hover:underline' onClick={() => deleteProduct(e.id)}>Delete</button>
                    </div>
                </div>
                </div>
            )
