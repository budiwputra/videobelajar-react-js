    ...
    return (
        <div className='relative'>
            ...
            sm:px-[120px] sm:py-[12px] '>
                ...
                <div className='hidden sm:flex sm:flex-row gap-[36px] items-center'>
                ...
                <ButtonMenu onClick={() => {navigate('category')}} className="flex items-center gap-[36px] hover:text-primary">Kategori 
                    ...
                    <img className='cursor-pointer w-[44px] aspect-square rounded-[10px]' onClick={() => setOpen(!open)} src={avaPic} alt="profile" />
                </div>
                ...
                <ul className="flex flex-col divide-y divide-other-border " >
                    ...
                    <li className="sm:hidden flex items-center gap-3 p-4 hover:bg-gray-100 ">
                    <ButtonMenu onClick={() => navigate('/home/category')}>Kategori</ButtonMenu>
                    </li>
                    <li className="flex items-center gap-3 p-4 hover:bg-gray-100">
                    <ButtonMenu onClick={() => navigate('/home/profile')}>Profil Saya</ButtonMenu>
                    </li>
                    <li className="flex items-center gap-3 p-4 hover:bg-gray-100">
