        ...
        <div className='relative'>
            ...
            sm:px-[120px] sm:py-[12px] '>
                ...
                <ul className="flex flex-col divide-y divide-other-border " >
                    ...
                    <BodyMedium className="text-dark-secondary">Profil Saya</BodyMedium>
                    </li>
                    <li className="flex items-center gap-3 p-4 hover:bg-gray-100">
                    <BodyMedium className="text-dark-secondary">Kelas Saya</BodyMedium>
                    </li>
                    <li className="flex items-center gap-3 p-4 hover:bg-gray-100">
                    <BodyMedium className="text-dark-secondary">Pesanan Saya</BodyMedium>
                    </li>
